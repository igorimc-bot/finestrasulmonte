<?php
$pageTitle = "Oasi di Piobbico - Appartamenti di Pregio e Natura sul Monte Nerone";
$pageDescription = "Vivi il relax esclusivo all'Oasi di Piobbico. Splendidi appartamenti con piscina e vista mozzafiato sul Monte Nerone, per la tua vacanza perfetta nelle Marche.";
$pageKeywords = "Oasi di Piobbico, appartamenti vacanza Marche, casa vacanze Monte Nerone, affitto turistico Piobbico, vacanza natura e piscina";
$currentPage = "home";
...
<main>
    <!-- Hero Section -->
    <section class="hero"
        style="background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.4)), url('assets/img/homepage_hero.jpeg') center/cover no-repeat; height: 100vh; display: flex; align-items: center; justify-content: center; text-align: center; color: var(--white);">
        <div class="hero-content reveal">
            <h1 style="font-size: clamp(3rem, 10vw, 5rem); margin-bottom: 20px;">Oasi di Piobbico</h1>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 40px;">
                ...
                <div class="reveal"
                    ...
                    <div style="height: 250px; background-color: #ddd;">
                        <img src="assets/img/residence_vista_piscina.jpg" alt="Appartamento 1 Residence Vista"
                            width="600" height="250" loading="lazy" decoding="async"
                ...
                <div class="reveal"
                    ...
                    <div style="height: 250px; background-color: #ddd;">
                        <img src="assets/img/piobbico_piscina.jpg" alt="Appartamento 2 Oasi" width="600" height="250"
